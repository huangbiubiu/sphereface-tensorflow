    ...
    with tf.name_scope("margin_inner_product_layer"):
        ...
        if m == 4:
            ...
            def grad_norm(unused_op, grad):
                ...
                return grad  # TODO ONLY FOR DEBUG: ablation study on gradient norm
            ...
            # logits = tf.add(phi_theta_grad, lambda_ * wx) / (1 + lambda_) # TODO ONLY FOR DEBUG: ablation study on gradient norm
